...
wget https://releases.mattermost.com/5.12.0-rc6/mattermost-5.12.0-rc6-linux-amd64.tar.gz
mv mattermost-5.12.0-rc6-linux-amd64.tar.gz mattermost.tar.gz

# Regular daily from release branch
# wget https://releases.mattermost.com/mattermost-platform/release-5.12/mattermost-enterprise-linux-amd64.tar.gz
# mv mattermost-enterprise-linux-amd64.tar.gz mattermost.tar.gz
