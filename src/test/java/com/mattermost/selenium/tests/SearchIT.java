...
public class SearchIT extends DriverBase {
    ...
    public void testSearchIT() throws Exception {        // LOG IN
        ...
        try {
            assertThat("one", is(not(driver.findElement(By.cssSelector("span.search-highlight")).getText())));
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
            assertThat("two", is(not(driver.findElement(By.cssSelector("span.search-highlight")).getText())));
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
