...
public class SearchIT extends DriverBase {
    ...
    public void testSearchIT() throws Exception {        // LOG IN
        ...
        driver.findElement(By.cssSelector("input.search-bar")).sendKeys(Keys.BACK_SPACE + Keys.BACK_SPACE + Keys.BACK_SPACE + Keys.BACK_SPACE + Keys.BACK_SPACE + Keys.BACK_SPACE + Keys.BACK_SPACE + Keys.BACK_SPACE);
        // Sleep
