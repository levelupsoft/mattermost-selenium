...
public class SearchIT extends DriverBase {
    ...
    public void testSearchIT() throws Exception {        // LOG IN
        ...
        for (int second = 0;; second++) {
        	if (second >= 2) fail("timeout");
        	try { if (!"one".equals(driver.findElement(By.cssSelector("span.search-highlight")).getText())) break; } catch (Exception e) {}
        	Thread.sleep(1000);
        }

        for (int second = 0;; second++) {
        	if (second >= 2) fail("timeout");
        	try { if (!"two".equals(driver.findElement(By.cssSelector("span.search-highlight")).getText())) break; } catch (Exception e) {}
        	Thread.sleep(1000);
        }
        ...
        try {
            assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*direct[\\s\\S]*$"));
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        // Warning: verifyTextNotPresent may require manual changes
        ...
        for (int second = 0;; second++) {
        	if (second >= 2) fail("timeout");
        	try { if ("test2".equals(driver.findElement(By.cssSelector("input.search-bar")).getAttribute("value"))) break; } catch (Exception e) {}
        	Thread.sleep(1000);
        }
        ...
        for (int second = 0;; second++) {
        	if (second >= 2) fail("timeout");
        	try { if ("@test2".equals(driver.findElement(By.linkText("@test2")).getText())) break; } catch (Exception e) {}
        	Thread.sleep(1000);
        }
